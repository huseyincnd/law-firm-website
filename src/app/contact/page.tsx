    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Hukuki süreçleriniz için yanınızdayız. Ücretsiz ilk görüşme için randevu alın veya sorularınız için bize ulaşın.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-red-600 text-white rounded-xl font-semibold hover:bg-red-700 transition-all duration-300 transform hover:-translate-y-1"
                >
                  Gönder
                </button>
              </form>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600 mt-1">
                        info@hukukburosu.com<br />
                        destek@hukukburosu.com
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3010.2755075542287!2d29.02827671541928!3d41.02757897929921!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab82beb25f5bf%3A0x57e3938ad727ab8!2sKad%C4%B1k%C3%B6y%2C%20Istanbul!5e0!3m2!1sen!2str!4v1647095757819!5m2!1sen!2str"
              width="100%"
              height="500"
              style={{ border: 0 }}
              allowFullScreen
